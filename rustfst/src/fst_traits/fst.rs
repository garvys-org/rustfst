...
pub trait CoreFst {
    ...
    // TODO: Might be interesting to return a Result<Option<_>> here to differentiate the cases where the state doesn't exist and the where the state is not final.
