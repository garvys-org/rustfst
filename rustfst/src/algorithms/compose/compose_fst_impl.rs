...
use crate::algorithms::compose::{ComposeFstImplOptions, ComposeStateTuple};
...
impl<W: Semiring, CF: ComposeFilter<W>> FstOp<W> for ComposeFstImpl<W, CF> {
...
impl<W: Semiring, CF: ComposeFilter<W>> FstImpl for ComposeFstImpl<W, CF> {
    type W = W;
