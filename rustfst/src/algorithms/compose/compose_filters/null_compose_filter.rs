    ...
    for NullComposeFilter<W, M1, M2>
{
    ...
    fn set_state(&mut self, fst1: &impl Fst<W>, fst2: &impl Fst<W>, _s1: usize, _s2: usize, _filter_state: &Self::FS) -> Result<()> {
        Ok(())
    }

    fn filter_tr(&mut self, fst1: &impl Fst<W>, fst2: &impl Fst<W>, arc1: &mut Tr<W>, arc2: &mut Tr<W>) -> Result<Self::FS> {
