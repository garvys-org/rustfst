...
fst_bench G_80MB invert invert $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB connect connect $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB reverse reverse $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB tr_sort tr_sort $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB tr_unique map --map_type tr_unique $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB tr_sum map --map_type tr_sum $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB map_input_epsilon map --map_type input_epsilon $FST_BENCH_RUSTFST/G.fst ./fst_output
fst_bench G_80MB map_rmweight map --map_type rmweight $FST_BENCH_RUSTFST/G.fst ./fst_output

fst_bench L_AND_G compose compose $FST_BENCH_RUSTFST/L.fst $FST_BENCH_RUSTFST/G.fst ./fst_output --compose_type default
fst_bench L_AND_G compose_lookahead compose $FST_BENCH_RUSTFST/L.fst $FST_BENCH_RUSTFST/G.fst ./fst_output --compose_type lookahead
